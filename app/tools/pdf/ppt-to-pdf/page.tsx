          ...
          <>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <label
                  htmlFor="ppt-input"
                  className="inline-flex items-center justify-center px-6 py-3 rounded-xl bg-orange-500 hover:bg-orange-600 text-white font-medium cursor-pointer transition-colors"
                >
